...
Thank you for contributing to `bitty-ai-docs`, the canonical documentation
repository for the `bitty-ai` AI-core sub-platform. The project is in a
...
```text
docs(providers): add provider capability overview
