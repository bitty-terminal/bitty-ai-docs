...
[v0.1 Implementation Profile](implementation-profile-v0.1.md), the dependency
...
- MP-10 API-key handling not reopened. Storage, redaction, consent
  ...
  [AI Architecture](ai-architecture.md); the MPC-2 reference-not-value rule
...
[AI Architecture](ai-architecture.md); management-UI design and plugin-registry
