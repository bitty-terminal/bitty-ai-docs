...
[AI Architecture](ai-architecture.md), the narrow scope gate in
[v0.1 Implementation Profile](implementation-profile-v0.1.md), the register in
[AI Unresolved Questions](ai-unresolved-questions.md), and the accepted
...
- R6 preserved, not reopened. The single-writer journal candidate, the
  ...
  [Persistence profile R6](persistence-profile-r6.md) all stand unchanged.
...
- R3 mandatory floor. Consent-bounded retention and deletion propagation in
  [Context retention R3](context-retention-r3.md) are requirements, not
...
- Sizing and performance language qualified. Catalog-size, backup-friendliness,
  ...
  [Persistence profile R6](persistence-profile-r6.md) (consent and redaction
...
[AI Unresolved Questions](ai-unresolved-questions.md) finds every storage
