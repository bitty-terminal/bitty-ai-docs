---
title: Research distillations
description: Index of AI-core research distillation records coverage ledger and triage
...
Index of the AI-core research distillation records. These pages preserve
provenance and observations; a distillation never becomes a decision or an
implementation claim by implication. Normative detail lives in the linked
specifications; this index carries no duplicate normative prose.

## Ledger and triage

| Document                                                                | Status | Purpose                                                                     |
| ----------------------------------------------------------------------- | ------ | --------------------------------------------------------------------------- |
| [Research coverage ledger](research-coverage-ledger.md)                 | Draft  | Coverage and disposition of the AI-relevant research records.               |
| [AIQ triage against landed work (2026-09-16)](aiq-triage-2026-09-16.md) | Draft  | Recommendation-only triage of every open AIQ facet against landed evidence. |
...
Distillations are research records, not contracts. When a record and the
maintained corpus disagree, the corpus wins. Authoring, metadata, and review
rules live in the
[documentation workflow](../../docs/development/documentation-workflow.md).
The parent [specifications index](../README.md) routes to the contracts these
records inform.
