...
[Agent coordination architecture](agent-coordination.md), the CarryCtx,
...
[AI Unresolved Questions](ai-unresolved-questions.md), and the R1 and R3
...
[Persistence and evidence architecture](persistence-evidence.md) and the
experimental scope and non-goals in
[v0.1 Implementation Profile](implementation-profile-v0.1.md) are inputs, not
conclusions: this decision selects no backend, no replay contract, and no
release scope. The accepted [IPC and Agent RFC](ipc-agent-rfc.md) and the
...
- Backend, index-option, replay-contract, and release-profile proposals stay
  in [Persistence and evidence architecture](persistence-evidence.md).
- Release-scope sequencing stays in
  [v0.1 Implementation Profile](implementation-profile-v0.1.md), whose
...
- [Agent coordination architecture](agent-coordination.md) (Draft): teams,
...
- [AI Unresolved Questions](ai-unresolved-questions.md) (Draft): AIQ-10 with
