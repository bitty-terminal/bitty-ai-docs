...
[Agent coordination architecture](agent-coordination.md), the exec and Panel
...
[AI Unresolved Questions](ai-unresolved-questions.md), and
...
- No-panel execution does not imply a persistent terminal daemon, detach and
  ...
  and trust-boundary gate cited by [Agent coordination architecture](agent-coordination.md)
  and [IPC and Agent RFC](ipc-agent-rfc.md).
...
[v0.1 Implementation Profile](implementation-profile-v0.1.md), the following
...
- [AI Unresolved Questions](ai-unresolved-questions.md) (Draft): AIQ-29,
