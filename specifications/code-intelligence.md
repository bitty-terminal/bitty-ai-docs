...
- [AI Architecture](ai-architecture.md) (Draft): tool bus and execution profiles
- [IPC and Agent RFC](ipc-agent-rfc.md) (Accepted): permission model for effectful proposals
