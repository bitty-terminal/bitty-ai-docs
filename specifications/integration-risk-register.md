...
> [IPC and Agent RFC](ipc-agent-rfc.md) and the governance corpus override any
> suggestion here.
...
[AI Unresolved Questions](ai-unresolved-questions.md); this register references
...
- restate the normative IPC, consent, transport, or lifecycle text; those stay
  in [IPC and Agent RFC](ipc-agent-rfc.md), [Tool transport R2](tool-transport-r2.md),
...
- [Task lifecycle R5](task-lifecycle-r5.md) (Draft): lifecycle authority and
  handoff fencing.
- [AI Architecture](ai-architecture.md) (Draft): bridge process model, Tool
  Bus, and Rich streaming vocabulary.
- [AI Unresolved Questions](ai-unresolved-questions.md) (Draft): open register
