...
**Draft relationship**: [AI Architecture](ai-architecture.md) AG-4 (Least privilege at dispatch) constrains these coordination proposals; AG-5 distinguishes orchestration from execution. This document accepts no new mechanism.
...
- [IPC and Agent RFC](ipc-agent-rfc.md) (Accepted): Panel lifecycle and IPC contracts
