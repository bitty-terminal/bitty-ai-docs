...
which elaborates [AI Architecture](ai-architecture.md) CP-5 (Budget), CP-6 (Artifacts),
CP-7 (Determinism and testability). See also AG-4 (Least privilege at dispatch)
in [AI Architecture](ai-architecture.md) for dispatch authorization, which this
...
[AI Architecture](ai-architecture.md) CP-6 (Artifacts). Panel state stays
...
- [AI Architecture](ai-architecture.md#privacy-first) PP-2 (Typed redaction)
...
security corpus linked from [AI Architecture](ai-architecture.md).
...
- [v0.1 Implementation Profile](implementation-profile-v0.1.md) (Draft):
  ...
  proposals.
- [AI Unresolved Questions](ai-unresolved-questions.md) (Draft): AIQ-12 and
