...
All non-alias choices remain open except AIQ-12 (Closed, adopted-draft) and the
...
### AIQ-11 and AIQ-12 dispositions (local draft only)
...
- **AIQ-12 — Closed (adopted-draft).** Choice: deterministic `prompt/1`
  ...
  prefix-stable. Evidence: [Prompt Layering Design](prompt-layering-design.md)
  assembly order (stable-before-dynamic) and [Prefix-Cache-Friendly Context
  Design](prefix-cache-context-design.md) prerequisite; code
...
- **AIQ-11 — Closed(partial): L0/L1 enforcement facet closed; compression and
  ...
  Architecture](context-management.md) Level 0, Level 1, and security-boundary
