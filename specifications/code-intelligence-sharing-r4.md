...
Inputs are [Code intelligence architecture](code-intelligence.md), the shared
workspace service supervision model in
[Agent coordination architecture](agent-coordination.md), AIQ-21, AIQ-22,
...
[Agent coordination architecture](agent-coordination.md), which this
...
2. The broker serves only the semantic tool surface defined in
   [Code intelligence architecture](code-intelligence.md): definitions,
...
- Team, delegation, budget, message, lease-lifecycle, and Panel proposals
  stay in [Agent coordination architecture](agent-coordination.md).
- Backend, index-option, replay-contract, and release-profile proposals
  stay in [Persistence and evidence architecture](persistence-evidence.md).
...
- [Agent coordination architecture](agent-coordination.md) (Draft): shared
  workspace service supervision, compatibility key, lease and generation
  fencing, and pressure and cancellation vocabulary.
- [AI Unresolved Questions](ai-unresolved-questions.md) (Draft): AIQ-21,
