...
> [IPC and Agent RFC](ipc-agent-rfc.md) and the normative security corpus
...
design](host-boundary-trait-design.md) (seam inventory over `ToolBus`,
provider selection, and disclosure primitives), and the draft
[Prototype-to-Core promotion checklist](prototype-promotion-checklist.md)
...
- Provenance for code intelligence: the draft [Code intelligence sharing
  R4](code-intelligence-sharing-r4.md) leans on verification reuse and
...
1. No-process-spawn Core. The runtime is std-only and sans-I/O by house
   ...
   checklist](prototype-promotion-checklist.md): `#![deny(unsafe_code)]`,
...
[promotion checklist](prototype-promotion-checklist.md): fail-closed typed
...
- Transport and presentation. Wire framing, Panel projection, and
  ...
  RFC](ipc-agent-rfc.md); the wrapper returns bounded views, never wire
  bytes.
...
[IPC and Agent RFC](ipc-agent-rfc.md) keeps its normative framing, scope,
lifecycle, and consent statements, and no sibling draft disposition
([Execution ownership R1](execution-ownership-r1.md), [Tool transport
R2](tool-transport-r2.md), [Provider plugin
boundary](provider-plugin-boundary.md), [HostBoundary trait and lint-gate
design](host-boundary-trait-design.md), [Prototype-to-Core promotion
checklist](prototype-promotion-checklist.md)) is revised by this document.
...
- [Code intelligence sharing R4](code-intelligence-sharing-r4.md)
  ...
  log-shaped.
- [IPC and Agent RFC](ipc-agent-rfc.md) (Accepted): normative IPC framing
