...
boundary](provider-plugin-boundary.md) (Core owns the contract, plugins own
...
- Transport and presentation. Wire framing, Panel projection, and rendering
  stay with the accepted [IPC and Agent RFC](ipc-agent-rfc.md) and AIQ-29;
...
[IPC and Agent RFC](ipc-agent-rfc.md) is unaffected: no normative framing,
...
boundary](provider-plugin-boundary.md)) are referenced as inputs only and
...
- [AI Unresolved Questions](ai-unresolved-questions.md) (Draft): AIQ-31 and
