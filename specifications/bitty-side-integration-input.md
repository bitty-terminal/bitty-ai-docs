...
3. The merged R1 disposition in [Execution ownership R1](execution-ownership-r1.md),
   ...
   and the R5 lifecycle boundary in [Task lifecycle R5](task-lifecycle-r5.md),
   with gap wording from [AI Vertical Slice Pressure Test](ai-vertical-slice-pressure-test.md)
   and register entries from [AI Unresolved Questions](ai-unresolved-questions.md).
...
- Links: [Execution ownership R1](execution-ownership-r1.md) (captured target
  and generation binding); [AI Vertical Slice Pressure Test](ai-vertical-slice-pressure-test.md)
  G-2; [v0.1 Implementation Profile](implementation-profile-v0.1.md)
...
- Links: [Tool transport R2](tool-transport-r2.md) (unified backend and
  declared placement); [AI Vertical Slice Pressure Test](ai-vertical-slice-pressure-test.md)
...
- Links: [Tool transport R2](tool-transport-r2.md) (gate order and fail-closed
  conditions); [Context retention R3](context-retention-r3.md) (pre-queue and
...
- Links: [Execution ownership R1](execution-ownership-r1.md) (option A,
...
- Links: [Execution ownership R1](execution-ownership-r1.md) (cancellation
  contract); [Tool transport R2](tool-transport-r2.md) (attributed outcomes);
...
- Links: [AI Vertical Slice Pressure Test](ai-vertical-slice-pressure-test.md)
  G-1; [Tool transport R2](tool-transport-r2.md) (terminal-boundary rule and
...
- Links: [AI Vertical Slice Pressure Test](ai-vertical-slice-pressure-test.md)
  G-4; [AI Architecture](ai-architecture.md) (RS-2 single scene path).
...
- Suggested priority: P2 (does not block the AI runtime; prevents further
  ownership drift).
- Links: [Execution ownership R1](execution-ownership-r1.md) (BA-2 agent
  versus AI split and BA-3 bridge process model); [AI Vertical Slice Pressure Test](ai-vertical-slice-pressure-test.md)
...
- Links: [v0.1 Implementation Profile](implementation-profile-v0.1.md)
  (in-scope runtime versus non-goals); [Task lifecycle R5](task-lifecycle-r5.md)
...
- Links: [v0.1 Implementation Profile](implementation-profile-v0.1.md)
  sequencing; [Persistence profile R6](persistence-profile-r6.md) (durability
...
- Links: [Execution ownership R1](execution-ownership-r1.md); [Tool transport R2](tool-transport-r2.md)
...
- Links: [Tool transport R2](tool-transport-r2.md); [Command and tool architecture](command-tool-architecture.md);
...
- Links: [Task lifecycle R5](task-lifecycle-r5.md); [Agent coordination architecture](agent-coordination.md);
...
- `bitty`-side ownership of persistence selection, language-service sharing,
  ...
  [Code intelligence sharing R4](code-intelligence-sharing-r4.md), and
  [Context retention R3](context-retention-r3.md) for boundary clarity only.
...
[AI Unresolved Questions](ai-unresolved-questions.md). Promotion of any
...
- [Execution ownership R1](execution-ownership-r1.md) (Draft): single-agent
  execution ownership, registry-split disposition, cancellation contract.
- [Tool transport R2](tool-transport-r2.md) (Draft): unified backend, declared
...
- [Context retention R3](context-retention-r3.md) (Draft): retention and
  redaction inheritance boundary.
- [Code intelligence sharing R4](code-intelligence-sharing-r4.md) (Draft):
  sharing boundary, cited as non-request only.
- [Persistence profile R6](persistence-profile-r6.md) (Draft): durability
...
- [AI Architecture](ai-architecture.md) (Draft): bridge process model, Tool
  Bus, and Rich streaming vocabulary.
- [Command and tool architecture](command-tool-architecture.md) (Draft): Core
  versus Lua boundary and tool classification.
- [Agent coordination architecture](agent-coordination.md) (Draft): lifecycle
